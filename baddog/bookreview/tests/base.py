...
def setup_product():
    ...
    import baddog.bookreview
    zcml.load_config('configure.zcml', baddog.bookreview)
    ...
    ztc.installPackage('baddog.bookreview')
...
setup_product()
ptc.setupPloneSite(products=['baddog.bookreview'])
